...
MIXPANEL_TOKEN = os.environ.get("SOCIAL_BLIMP_MIXPANEL_TOKEN", "")
...
ROOT_URLCONF = 'social_blimp.urls'

WSGI_APPLICATION = 'social_blimp.wsgi.application'
...
AWS_STORAGE_BUCKET_NAME = "social-blimp-static"
